...
const routes: Routes = [
  { path: 'app11_1/hello', component: HelloComponent },
  { path: 'app11_1/lazy', loadChildren: () => import('./lazy/lazy.module').then(m => m.LazyModule) },
  { path: 'app11_1', component: HomeComponent },
  /*
