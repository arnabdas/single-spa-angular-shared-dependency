...
const routes: Routes = [
  { path: 'app11_m/hello', component: HelloComponent },
  { path: 'app11_m/lazy', loadChildren: () => import('./lazy/lazy.module').then(m => m.LazyModule) },
  { path: 'app11_m', component: HomeComponent },
  /*
